...
SEED_TASKS = [
    ...
    {
        "title": "Вход в Roblox",
        "description": "Настоящий ли это сайт Roblox? Попробуй войти и узнай.",
        "instructions": "Введи логин и пароль (можно любые — это симуляция), чтобы продолжить.",
        "topic": "phishing",
        ...
        "content": {
            ...
            "real_url": "roblox.com/auth",
            "red_flags": [
                "Адрес сайта отличается: roblox/com/auth вместо roblox.com/auth",
                "Ссылка пришла от незнакомца или из чата",
                "Спешка: «Войди сейчас, иначе потеряешь аккаунт»",
            ],
        },
    },
]